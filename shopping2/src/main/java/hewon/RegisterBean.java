...
public class RegisterBean{
	...
	private String mem_passwd; //ȸ����ȣ�� ������ ����
	private String mem_name;   //ȸ���̸��� ������ ����
	private String mem_num1;   //ȸ���� �ֹε�Ϲ�ȣ ���ڸ��� ������ ����
	private String mem_num2;   //ȸ���� �ֹε�Ϲ�ȣ ���ڸ��� ������ ����
	private String mem_email;  //ȸ���� �̸����� ������ ����
	private String mem_phone;  //ȸ���� ��ȭ��ȣ�� ������ ����
	private String mem_zipcode; //ȸ���� �����ȣ�� ������ ����
	private String mem_address; //ȸ���� �ּҸ� ������ ����
	private String mem_job;     //ȸ���� ������ ������ ����
