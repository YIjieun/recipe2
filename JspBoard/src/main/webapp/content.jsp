<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    import="yje.board.*,java.text.SimpleDateFormat"%>
<!DOCTYPE html>
<html>
<head>
<title>게시판</title>
...
<%
// 글상세보기=>게시판(쇼핑몰 상품의 정보를 자세히(SangDetial.jsp?sangid=3&pageNum=1))
...
<table width="500" border="1" cellspacing="0" cellpadding="0"  bgcolor="#e0ffff" align="center">  
  ...
  <tr height="30">      
    <td colspan="4" bgcolor="#b0e0e6" align="right" > <!--colspan =>병합  -->
