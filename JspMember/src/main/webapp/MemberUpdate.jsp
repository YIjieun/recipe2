...
<link href="style.css?ver=1" rel="stylesheet" type="text/css"><!--방법2 css파일의 변동사항이 있을때?ver=1 추가 -->
<script language="JavaScript" src="script.js?ver=1"></script><!--방법2 js파일의 변동사항이 있을때?ver=1 추가 -->
</head>
<body bgcolor="#996600">
<br><br>
<%
	/*1)post 전달(inpit box를 이용) 2)get(링크걸기) 3)post 전달 hidden이용 하는 경우
	...
	*/
	...
	MemberDTO mem=memMgr.getMember(mem_id);//select * from member where id='nup';
    ...
    <td align="center" valign="middle" bgcolor="#FFFFCC"> 
      <table border="1" cellspacing="0" cellpadding="2"  align="center">
        <form name="regForm" method="post" action="MemberUpdateProc.jsp">
          ...
          <tr> <!-- 행 -->
            <td width="16%">아이디</td><!-- id는 pk이기 때문에 수정불가 -->
		  ...
		  <tr>  
            <td>직업</td><!--콤보박스에 없는 값을 필드에 저장시키면 연결이 안된 것처럼 보인다.  -->
          ...
          <!--직접 입력을 받는 것이 아닌경우 hidden 객체로 전달  
          	form 태그 안쪽에 
