...
<script>
	...
	<div class="container con_wrap">
		...
		<div class="con_box">
			...
			<div class="row">
				<div class="col-md-4">
					<img src="images/kimbab.jpg" width="250" height="200"/>
					<a href="/">[한식]키토김밥</a>								
				</div>
				<div class="col-md-4">
					<img src="images/radish.png" width="250" height="200"/>
					<a href="/">[한식]소고기무국</a>	
				</div>
				<div class="col-md-4">
					<img src="images/pizza.jpg" width="250" height="200"/>
					<a href="/">[간식]피자토스트</a>	
				</div>
		    </div>
		...
		<div class="table-responsive con_table">
			...
			<div align="center">
			<form class="form-inline" name="searchFrm" method="post" action="/main/main.jsp?PATH=/board/boardList.jsp">
				<div class="form-group">
					<select class="form-control" name="keyField" id="form-control">
						<option value="b_nick">이 름</option>
				...
				<input type="hidden" name="b_division1" value="qna"> 
				<input type="button" value="찾기" class="btn btn-default" onclick="check()">
