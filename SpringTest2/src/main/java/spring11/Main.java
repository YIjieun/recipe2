...
public class Main {
	...
	public static void main(String[] args) {
		...
		SystemMoniter moniter=context.getBean("doorMoniter",SystemMoniter.class);//3.x버전		
		System.out.println("moniter=>"+moniter);
		
		SystemMoniter moniter2=context.getBean("lobbyMoniter",SystemMoniter.class);//3.x버전		
		System.out.println("moniter2=>"+moniter2);
		
		SystemMoniter moniter3=context.getBean("roomMoniter",SystemMoniter.class);//3.x버전		
