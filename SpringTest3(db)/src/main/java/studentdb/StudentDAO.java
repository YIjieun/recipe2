...
public interface StudentDAO {
	...
	//2.insert->insert into 테이블명;
	public void create(Integer id,String name,Integer age);//create(Student st)
	...
	public void delete(Integer id);//delete(Student st)
	
	//6.학생정보를 수정->update 테이블명 set 필드명=값,,,, where조건식
	public void update(Integer id,Integer age);//(int,int)  update(Student st) 
}
